...
/*Create a function that takes in 1 number. Console log the cube root of 
the number. Call the function.*/
...
//*Loops*
/*Create a function that takes in a number. Console log every number 
from 1 to that number while skipping multiples of 5.*/

function skip5s(n){
    for(let i = 1; i <= n; i++){
        if(i % 5 !== 0 ){   //is the number divisble by 5, as long as its not equal 0
            console.log(i)
        }
    }
}
