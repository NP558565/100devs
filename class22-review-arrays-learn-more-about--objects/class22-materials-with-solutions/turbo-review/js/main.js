// *Variables*
/*Declare a variable and assign it to your fav drink as a string. Make sure 
there is no whitespace on either side of the string, and print the value to 
the console*/
let favDrink = " water"
...
if(multiword.search("apple") !== -1) {//if search did not find apple then-1
    console.log("yes")
} else {
    console.log("no")
}
// *Functions*
/*Create a function that returns rock, paper, or scissors as randomly as 
possible*/
function rockPaperScissors() {
  let random = Math.random();//use this to return randmly number 0&1
  if (random < 0.33) {
...
favDrink = favDrink.trim() //trim is a method
console.log(favDrink)
